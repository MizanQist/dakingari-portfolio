# The Dakingari Portfolio

A private, single-page portfolio of ten residential addresses (nine in Abuja, one in Victoria Island, Lagos), prepared by Mizan Qist Limited for Mr Babangida Dakingari. Static site: `index.html` + `assets/`, no build step needed to host it.
